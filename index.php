...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $github_token = "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"; // Replace with your new GitHub Token
    $repo_owner   = "LTC-Felipyzz";          // Your GitHub Username
    $repo_name    = "C3.0F";                 // Ensure whether this is a zero (0) or letter (O)
    ...
    curl_setopt_array($ch, array(
        ...
        CURLOPT_SSL_VERIFYPEER => false // Bypasses local SSL certificate checks
    ));
...
<head>
    ...
    <style>
        ...
        .status { font-size: 13px; color: #57606a; margin-top: 8px; word-break: break-all; }
    </style>
</head>
<body>
